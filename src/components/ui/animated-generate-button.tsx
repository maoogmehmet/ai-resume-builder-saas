...
export default function AnimatedGenerateButton({
  ...
  return (
    <div className={clsx("relative", isFullWidth ? "block" : "inline-block", className)} id={id}>
      <button
        type={type}
        ...
        style={
          {
            ...
            ["--radius" as any]: size === 'sm' ? '12px' : size === 'md' ? '24px' : size === 'lg' ? '32px' : '40px',
      ...
      <style jsx>{`
        ...
        .ui-anim-btn:focus-within .ui-anim-txt-1 {
          animation: ui-opacity-swap 0.3s ease-in-out forwards;
          animation-delay: 1s;
        }
        .ui-anim-btn:focus-within .ui-anim-txt-2 {
        ...
        .ui-anim-btn:focus-within .ui-anim-letter {
          animation:
        ...
        .ui-anim-btn:focus-within .ui-anim-btn-svg {
          animation-duration: 1.2s;
          animation-delay: 0.2s;
        }

        .ui-anim-btn:focus-within::before {
          box-shadow:
        ...
        .ui-anim-btn:focus-within::after {
          opacity: 0.6;
