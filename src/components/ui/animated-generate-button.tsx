...
const AnimatedGenerateButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, AnimatedGenerateButtonProps>(
  (
    {
      className,
      labelIdle = "Generate",
    ...
    const sizeClasses = {
      sm: "text-[11px] px-3 py-1.5 rounded-[12px]",
      md: "text-sm px-4 py-2 rounded-[24px]",
      lg: "text-base px-8 py-3.5 rounded-[32px]",
      xl: "text-lg px-10 py-4 rounded-[40px]",
      icon: "p-2 rounded-[12px]",
    };

    const isFullWidth = className?.includes("w-full") && size !== "icon";
        ...
        <style jsx>{`
          ...
          .ui-anim-btn::before {
            ...
            box-shadow: 0 -8px 8px -6px #0000 inset,
              0 -16px 16px -8px #00000000 inset, 1px 1px 1px #fff2,
              2px 2px 2px #fff1, -1px -1px 1px #0002, -2px -2px 2px #0001;
          }
          ...
          .ui-anim-btn:focus::before {
            box-shadow: 0 -8px 12px -6px #fff3 inset,
              0 -16px 16px -8px var(--highlight-20) inset, 1px 1px 1px #fff3,
              2px 2px 2px #fff1, -1px -1px 1px #0002, -2px -2px 2px #0001;
          }
          ...
          .ui-anim-btn:hover::before {
            box-shadow: 0 -8px 8px -6px #fffa inset,
              0 -16px 16px -8px var(--highlight-30) inset, 1px 1px 1px #fff2,
              2px 2px 2px #fff1, -1px -1px 1px #0002, -2px -2px 2px #0001;
          }
          ...
          .ui-anim-btn:active::before {
            box-shadow: 0 -8px 12px -6px #fffa inset,
              0 -16px 16px -8px var(--highlight-80) inset, 1px 1px 1px #fff4,
              2px 2px 2px #fff2, -1px -1px 1px #0002, -2px -2px 2px #0001;
          }
...
AnimatedGenerateButton.displayName = "AnimatedGenerateButton";
