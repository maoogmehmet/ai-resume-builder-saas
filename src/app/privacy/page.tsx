        ...
        <main className="min-h-screen bg-black text-white">
            <div className="max-w-3xl mx-auto px-6 py-20">
                ...
                <div className="space-y-10">
                    {[
                        { title: '1. Information We Collect', body: 'We collect information you provide directly to Maoog Software ("we", "us"): name, email address, resume content, and payment information. We also collect usage data including how you interact with the Service, device information, and IP addresses for security and analytics purposes.' },
                        ...
                        { title: '7. Your Rights', body: 'You have the right to: access your personal data, correct inaccurate data, delete your account and all associated data, export your data in a portable format, and opt out of marketing communications. Contact privacy@maoog.software to exercise these rights.' },
                        ...
                        { title: '10. Contact', body: 'For privacy inquiries or to exercise your rights, contact us at privacy@maoog.software.' },
                    ].map((s) => (
                        <section key={s.title}>
